package com.a221103797.uts_221103839;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void tampilkanButton_onClick(View view) {
        ...
        if (!url.startsWith("https://")) {
            ...
            // Kustom Notifikasi
            RemoteViews remoteViews = new RemoteViews(getPackageName(), R.layout.custom_notifikasi);
            remoteViews.setTextViewText(R.id.text_nim, "NIM: 221103839");
